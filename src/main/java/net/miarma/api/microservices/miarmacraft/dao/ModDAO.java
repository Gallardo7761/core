...
public class ModDAO implements DataAccessObject<ModEntity> {
	...
	@Override
	public Future<ModEntity> deleteDoubleId(Integer id1, Integer id2) {
		throw new UnsupportedOperationException("Delete by double ID is not supported for ModEntity.");
	}
